...
export default function ({ navigation }) {
 ...
 //    db.transaction((tx) => {
	//   tx.executeSql('ALTER TABLE items ADD COLUMN bulan TEXT');
	// });
  ...
  return (
	...
	<Button status="primary" onPress={showDatepicker} text="Tanggal transaksi" />
      {show && (
        <DateTimePicker
      ...
      <Button status="warning" text="Reset" onPress={resetItem} />
      <Button style={{ 
			    marginTop: 20,
