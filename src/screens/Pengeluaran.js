...
export default function ({ navigation }) {
 ...
 //    db.transaction((tx) => {
  ...
  return (
	...
	<Button style={{paddingVertical: 1,
          height: 40}} status="primary" onPress={showDatepicker} text="tanggal transaksi" />
      {show && (
        <DateTimePicker
      ...
      <Button style={{ paddingVertical: 1,
          height: 40}} status="warning" text="Reset" onPress={resetItem} />
      <Button style={{ 
			    marginTop: 10,
          paddingVertical: 1,
          height: 40
